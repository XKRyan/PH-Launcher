(() => {
  ...
  function titleFor(session) { return session.title || session.messages.find((message) => message.role === 'user')?.content.slice(0, 32) || '新会话'; }
