(() => {
  ...
  async function save(event) {
    ...
    const value = { title: fields.title.value, date: fields.date.value, start: fields.allDay.checked ? '' : fields.start.value, end: fields.allDay.checked ? '' : fields.end.value, notes: fields.notes.value, color: fields.color.value };
